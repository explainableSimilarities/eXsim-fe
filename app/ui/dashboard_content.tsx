...
import CardButton from "./button_card";
export default function DashboardContent({ unit }: { unit: Unit }) {
    ...
    const unitEntities = unit.entities.map(r => 
        ...
        callback={() => {router.push("/" + r.entity[0].name[0])}}
      />
    );
    ...
    return (
        ...
        <div className='transition-all flex w-full flex-wrap gap-4'>
            <CardButton
                icon="M19.902 4.098a3.75 3.75 0 0 0-5.304 0l-4.5 4.5a3.75 3.75 0 0 0 1.035 6.037.75.75 0 0 1-.646 1.353 5.25 5.25 0 0 1-1.449-8.45l4.5-4.5a5.25 5.25 0 1 1 7.424 7.424l-1.757 1.757a.75.75 0 1 1-1.06-1.06l1.757-1.757a3.75 3.75 0 0 0 0-5.304Zm-7.389 4.267a.75.75 0 0 1 1-.353 5.25 5.25 0 0 1 1.449 8.45l-4.5 4.5a5.25 5.25 0 1 1-7.424-7.424l1.757-1.757a.75.75 0 1 1 1.06 1.06l-1.757 1.757a3.75 3.75 0 1 0 5.304 5.304l4.5-4.5a3.75 3.75 0 0 0-1.035-6.037.75.75 0 0 1-.354-1Z"
                callback={() => {router.push("/expansion")}}
                mainText="Similar entities"
                secondaryText="Find other entities similar to the selected ones"
            />
        ...
        <div className='transition-all flex w-full flex-wrap gap-4 pb-14'>
            {unitEntities}
        </div>
        </>
    );
